...
def generate_kl_snapshot(data_dir: str, target_step: float):
    ...
    for csv_file in csv_files:
        ...
        os.makedirs("/home/mil/shitanda/CPO_paper_materials/3_ICLR2026_Rebbuttal/2_colormap/colormap_output", exist_ok=True)
        output_path = os.path.join("/home/mil/shitanda/CPO_paper_materials/3_ICLR2026_Rebbuttal/2_colormap/colormap_output", output_name)
        plt.tight_layout()
...
data_dir = "/home/mil/shitanda/CPO_paper_materials/3_ICLR2026_Rebbuttal/data/0_KL"
